...
export default {
  ...
  computed: {
    isDark() {
      const injectedMode = this.normalizeThemeValue(this.mode);
  ...
  methods: {
    normalizeThemeValue(value) {
      ...
      if (resolvedValue && typeof resolvedValue === 'object') {
        return this.normalizeThemeValue(
          resolvedValue.value ??
          resolvedValue.mode ??
          resolvedValue.theme
        );
    ...
    detectGlobalDarkTheme() {
      ...
      const hasDarkClass = (element) =>
        darkClasses.some((className) =>
    ...
    syncGlobalTheme() {
      this.globalThemeDark = this.detectGlobalDarkTheme();
    },
